      ...
      {boxes.map(b => (
        <div
          ...
          style={{
            ...
            border: activeId === b.id 
              ? '3px solid #3b82f6' 
              : '2px solid #06b6d4', // より洗練されたティール色
            background: activeId === b.id
              ? 'rgba(59, 130, 246, 0.15)' 
              : 'rgba(6, 182, 212, 0.08)', // より薄く上品に
            borderRadius: '8px', // 少し丸みを強く
            ...
            transition: 'all 0.3s cubic-bezier(0.4, 0, 0.2, 1)', // よりスムーズなアニメーション
        ...
        >
          <span 
            ...
            style={{
              backgroundColor: activeId === b.id ? '#3b82f6' : '#0891b2', // より深いティール色
